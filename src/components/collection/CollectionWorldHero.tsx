...
export default function CollectionWorldHero({
  ...
  useParallaxTransform(mediaRef, isGems ? 0 : 0.28, isGems ? 0 : 0.00022);
      ...
      <section className="relative h-[92svh] min-h-[640px] overflow-hidden bg-[#030303]">
        ...
        <div className="relative z-10 flex h-full items-center justify-center px-6 pt-24 text-center sm:px-12 lg:w-[42%] lg:px-16 lg:pt-16">
          <div className="max-w-xl">
            <p className="saaq-hero-rise font-sans text-[10px] uppercase tracking-[0.38em] text-saaq-gold">
              {content.eyebrow}
            </p>
            <DisplayHeading
              as="h1"
  ...
  return (
    <section className="relative h-[92svh] min-h-[640px] overflow-hidden bg-saaq-black">
      <div ref={mediaRef} className="absolute inset-[-14%] will-change-transform">
        <Image
          src={content.heroImage}
          alt=""
          fill
          ...
          unoptimized
          sizes="100vw"
          className="saaq-hero-media object-cover object-[center_30%]"
        />
      </div>

      <div className="absolute inset-0 bg-gradient-to-r from-saaq-black via-saaq-black/55 to-transparent" />
      ...
      <div className="relative z-10 flex h-full items-center justify-start px-6 pt-20 sm:px-12 lg:px-20">
